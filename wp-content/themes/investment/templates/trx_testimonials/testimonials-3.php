...
if ( !function_exists( 'investment_template_testimonials_3_theme_setup' ) ) {
	add_action( 'investment_action_before_init_theme', 'investment_template_testimonials_3_theme_setup', 1 );
	function investment_template_testimonials_3_theme_setup() {
		investment_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 3/', 'investment'),
			'thumb_title'  => esc_html__('Avatar (small)', 'investment'),
			'w'		 => 166,
			'h'		 => 166
		));
	}
...
// Template output
if ( !function_exists( 'investment_template_testimonials_3_output' ) ) {
	function investment_template_testimonials_3_output($post_options, $post_data) {
		$show_title = true;
