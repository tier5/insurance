...
if ( !function_exists( 'investment_template_services_1_theme_setup' ) ) {
	add_action( 'investment_action_before_init_theme', 'investment_template_services_1_theme_setup', 1 );
	function investment_template_services_1_theme_setup() {
		investment_add_template(array(
			'layout' => 'services-1',
			'template' => 'services-1',
			'mode'   => 'services',
			'title'  => esc_html__('Services /Style 1/', 'investment'),
...
// Template output
if ( !function_exists( 'investment_template_services_1_output' ) ) {
	function investment_template_services_1_output($post_options, $post_data) {
