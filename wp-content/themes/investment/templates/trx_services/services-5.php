...
if ( !function_exists( 'investment_template_services_5_theme_setup' ) ) {
    add_action( 'investment_action_before_init_theme', 'investment_template_services_5_theme_setup', 1 );
    function investment_template_services_5_theme_setup() {
        investment_add_template(array(
            'layout' => 'services-5',
            'template' => 'services-5',
            'mode'   => 'services',
            'title'  => esc_html__('Services /Style 5/', 'investment'),
...
// Template output
if ( !function_exists( 'investment_template_services_5_output' ) ) {
    function investment_template_services_5_output($post_options, $post_data) {
