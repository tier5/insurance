...
if ( !function_exists( 'investment_template_services_4_theme_setup' ) ) {
	add_action( 'investment_action_before_init_theme', 'investment_template_services_4_theme_setup', 1 );
	function investment_template_services_4_theme_setup() {
		investment_add_template(array(
			'layout' => 'services-4',
			'template' => 'services-4',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 4/', 'investment')
		));
	}
}

// Template output
if ( !function_exists( 'investment_template_services_4_output' ) ) {
	function investment_template_services_4_output($post_options, $post_data) {
