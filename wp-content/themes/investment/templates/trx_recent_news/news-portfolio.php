...
if ( !function_exists( 'investment_template_news_portfolio_theme_setup' ) ) {
	add_action( 'investment_action_before_init_theme', 'investment_template_news_portfolio_theme_setup', 1 );
	function investment_template_news_portfolio_theme_setup() {
		investment_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'investment'),
...
// Template output
if ( !function_exists( 'investment_template_news_portfolio_output' ) ) {
	function investment_template_news_portfolio_output($post_options, $post_data) {
