...
if ( !function_exists( 'investment_template_news_magazine_theme_setup' ) ) {
	add_action( 'investment_action_before_init_theme', 'investment_template_news_magazine_theme_setup', 1 );
	function investment_template_news_magazine_theme_setup() {
		investment_add_template(array(
			'layout' => 'news-magazine',
			'template' => 'news-magazine',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Magazine/', 'investment'),
...
// Template output
if ( !function_exists( 'investment_template_news_magazine_output' ) ) {
	function investment_template_news_magazine_output($post_options, $post_data) {
