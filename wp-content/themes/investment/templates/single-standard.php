...
if ( !function_exists( 'investment_template_single_standard_theme_setup' ) ) {
	add_action( 'investment_action_before_init_theme', 'investment_template_single_standard_theme_setup', 1 );
	function investment_template_single_standard_theme_setup() {
		investment_add_template(array(
			'layout' => 'single-standard',
			'mode'   => 'single',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single standard', 'investment'),
			'thumb_title'  => esc_html__('Fullwidth image (crop)', 'investment'),
			'w'		 => 1170,
			'h'		 => 659
		));
	}
...
// Template output
if ( !function_exists( 'investment_template_single_standard_output' ) ) {
	function investment_template_single_standard_output($post_options, $post_data) {
		...
		if (!$sidebar_present) investment_close_wrapper();	// .post_item
