...
if ( !function_exists( 'investment_template_portfolio_theme_setup' ) ) {
	add_action( 'investment_action_before_init_theme', 'investment_template_portfolio_theme_setup', 1 );
	function investment_template_portfolio_theme_setup() {
		investment_add_template(array(
			'layout' => 'portfolio_2',
			'template' => 'portfolio',
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile (with hovers, different height) /2 columns/', 'investment'),
		...
		investment_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /3 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium image', 'investment'),
			'w'		 => 370,
			'h_crop' => 209,
			'h'		 => null
		...
		investment_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /4 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium image', 'investment'),
			'w'		 => 370,
			'h_crop' => 209,
			'h'		 => null
		...
		investment_add_template(array(
			...
			'title'  => esc_html__('Grid tile (with hovers, equal height) /2 columns/', 'investment'),
		...
		investment_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /3 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium image (crop)', 'investment'),
			'w'		 => 370,
			'h'		 => 209
		));
		investment_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /4 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium image (crop)', 'investment'),
			'w'		 => 370,
			'h'		 => 209
		));
		investment_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile (with hovers, width=height) /2 columns/', 'investment'),
		...
		investment_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /3 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'investment'),
			'w'		 => 370,
			'h'		 => 370
		));
		investment_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /4 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'investment'),
			'w'		 => 370,
			'h'		 => 370
		));
		investment_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored excerpt', 'investment'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'investment'),
			'w'		 => 370,
			'h'		 => 370
		));
		investment_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile (with hovers, width=height) /2 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'investment'),
			'w'		 => 370,
			'h' 	 => 370
		));
		investment_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /3 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'investment'),
			'w'		 => 370,
			'h'		 => 370
		));
		investment_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /4 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'investment'),
			'w'		 => 370,
			'h'		 => 370
		));
		investment_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /2 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'investment'),
			'w'		 => 370,
			'h' 	 => 370
		));
		investment_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /3 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'investment'),
			'w'		 => 370,
			'h'		 => 370
		));
		investment_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /4 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'investment'),
			'w'		 => 370,
			'h'		 => 370
		));
		investment_add_template(array(
			...
			'title'  => esc_html__('Alternative grid (with hovers) /2 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'investment'),
			'w'		 => 370,
			'h' 	 => 370
		));
		investment_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /3 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'investment'),
			'w'		 => 370,
			'h'		 => 370
		));
		investment_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /4 columns/', 'investment'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'investment'),
			'w'		 => 370,
			'h'		 => 370
		));
		// Add template specific scripts
		add_action('investment_action_blog_scripts', 'investment_template_portfolio_add_scripts');
	}
}

// Add template specific scripts
if (!function_exists('investment_template_portfolio_add_scripts')) {
	//add_action('investment_action_blog_scripts', 'investment_template_portfolio_add_scripts');
	function investment_template_portfolio_add_scripts($style) {
		if (investment_substr($style, 0, 10) == 'portfolio_' 
			|| investment_substr($style, 0, 5) == 'grid_' 
			|| investment_substr($style, 0, 7) == 'square_' 
			|| investment_substr($style, 0, 6) == 'short_'
			|| investment_substr($style, 0, 6) == 'alter_' 
			|| investment_substr($style, 0, 8) == 'colored_') {
...
// Template output
if ( !function_exists( 'investment_template_portfolio_output' ) ) {
	function investment_template_portfolio_output($post_options, $post_data) {
		...
		if ($style == 'colored' && $columns==1) {				// colored excerpt style (1 column)
					...
					<div class="post_content isotope_item_content">
						<div class="post_featured img">
							...
							*/
							...
							$new = investment_get_custom_option('mark_as_new', '', $post_data['post_id'], $post_data['post_type']);					// !!!!!! Get option from specified post
							if ($new && $new > date('Y-m-d')) {
								?><div class="post_mark_new"><?php esc_html_e('NEW', 'investment'); ?></div><?php
							}
							?>
						</div>
						...
						<div class="post_description clearfix">
							...
							<?php if ($post_data['post_link'] != '') { ?>
								<div class="post_buttons">
									<?php echo trim(investment_sc_button(array('size'=>'small', 'link'=>$post_data['post_link']), esc_html__('LEARN MORE', 'investment'))); ?>
								</div>
							<?php } ?>
						</div>
					</div>				<!-- /.post_content -->
			...
			if ($style=='alter') {
				...
				$alter_size = explode('_', investment_get_custom_option('alter_thumb_size', '1_1', $post_data['post_id'], $post_data['post_type']));	// !!!!!! Get option from specified post
				$alter_size[0] = max(1, $alter_size[0]);
				$alter_size[1] = max(1, empty($alter_size[1]) ? 1 : $alter_size[1]);
				$post_data['post_thumb'] = investment_get_resized_image_tag($post_data['post_attachment'], 
									...
									if ($post_data['post_protected']) {
										...
										if ($post_data['post_excerpt']) {
											echo in_array($post_data['post_format'], array('quote', 'link', 'chat', 'aside', 'status')) 
												...
												: '<p>' . ($link_start) 
													. (investment_strpos($post_options['hover'], 'square')!==false
														? strip_tags($post_data['post_excerpt'])
														: trim(investment_strshort($post_data['post_excerpt'], isset($post_options['descr']) ? $post_options['descr'] : investment_get_custom_option('post_excerpt_maxlength_masonry'))) 
														)
													. ($link_end) . '</p>';
										}
