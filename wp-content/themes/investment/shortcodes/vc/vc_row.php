...
if (function_exists('vc_map_get_attributes')) {						// New VC
	...
	// Add Investment color scheme in the row
	if ($scheme && !investment_param_is_off($scheme) && !investment_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	...
	// Add Investment color scheme in the row
	if ($scheme && !investment_param_is_off($scheme) && !investment_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
